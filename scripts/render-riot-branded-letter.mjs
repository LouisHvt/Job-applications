...
const PARAGRAPHS = [
  ...
  `Last year I spent a month in Riyadh with Gen.G, helping run the Superfan Program at the Esports World Cup. I coordinated vendors, worked alongside the broadcast and sponsorship teams to keep the creative vision intact on site, and looked after the technical side of the activation with our production partners, from LED screens to power and connectivity. The month asked a lot of us, and I enjoyed every day of it.`,
  ...
  `APAC is a region I love. I have travelled it extensively and feel at ease with its different cultures, even though I have not worked there yet. I do not speak Mandarin or Japanese today, but I am ready to learn whichever language the subregion needs. I know Singapore, I would be happy to call it home, and I am currently securing a Work Holiday Pass that lets me work there without sponsorship from day one.`,
  `I am genuinely excited about this role. It is one of those rare jobs where I can picture myself completely, and I would love the opportunity to prove it. Thank you for your time and consideration. I would be glad to talk about how I can help the team deliver memorable events across the region.`,
]
